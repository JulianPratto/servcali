...
if (isset($_SESSION['user_rol'])) {
    if ($_SESSION['user_rol'] != 2 && $_SESSION['user_rol'] != 9) {
...
$result_materia = $conexion->query($sql)
    or die(mysqli_errno($conexion) . " : "
        . mysqli_error($conexion) . " | Query=" . $sql);
$materia = array();
while ($fila = $result_materia->fetch_assoc()) {
    $materia[] = $fila;
}
...
';
        ...
        <div id="layoutSidenav_content">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../Reportes/inventario.php" class="btn btn-secondary">
                            Inventory Report</a>
                            <div id="formulario">
                                <form class="row g-3" role="form" id="form1">
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <select class="form-control" name="materia" id="inputMateria">
                                            ...
                                            <?php foreach ($materia as $fila) { ?>
                                                <option value="<?php echo $fila['id_materiaprima'] ?>"> <?php echo $fila['descripcion'] ?> </option>;
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input autocomplete="off" type="number" class="form-control" name="cantidad" id="inputCantidad" placeholder="Enter the amount" value="">
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <?php foreach ($listado as $fila) { ?>
                                            ...
                                            <td>
                                                <button class="btn btn-success btn-sm edit" data-id="<?php echo $fila['id_inventario'] ?>">
                                                    <i class="fas fa-pen" aria-hidden="true"></i>
                                                </button>
                                                <button class="btn btn-danger btn-sm delete" data-id="<?php echo $fila['id_inventario'] ?>">
            ...
            <script type="text/javascript" src="../js/funcionesInventario.js"></script>
